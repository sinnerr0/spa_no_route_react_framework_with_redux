class ShowwindowCtrl {
    constructor(component) {
        ...
        this.component.setKeys([G.RCU.KEY_LEFT, G.RCU.KEY_RIGHT, G.RCU.KEY_UP, G.RCU.KEY_DOWN, G.RCU.KEY_ENTER, G.RCU.KEY_1, G.RCU.KEY_2, G.RCU.KEY_BACK, G.RCU.KEY_EXIT]);
